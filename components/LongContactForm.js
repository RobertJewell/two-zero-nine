	...
	return (
		<div className="container px-4 mx-auto mt-20 text-white lg:max-w-5xl mb-8">
			...
			>
				<motion.div
					layout
					className="relative w-full min-h-200 max-w-4xl mx-auto md:flex-1"
				>
					...
					<AnimatePresence exitBeforeEnter>
						<motion.form
							...
							exit={{ opacity: 0 }}
							className={
								`w-full max-w-4xl px-8 py-16 mx-auto transition-all delay-200 duration-500 md:flex-1` +
						...
						>
							...
							<div className="flex flex-col md:flex-row">
								<div className="flex flex-col md:mr-8 flex-1">
									...
									<p className="text-gray-300 mb-6">
										The important bits! The more info you can give me, the
										quicker we can get started.
									</p>
								</div>
